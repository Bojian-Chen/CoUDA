...
def incremental_train_cua(args, model, model_old, src_trainloader, tgt_trainloader, src_testloader , testloader, exemplar_dataset, tg_optimizer, tg_lr_scheduler, weight_per_class=None, device = None):
